...
<<<<<<< HEAD
    $.get("https://api.openweathermap.org/data/2.5/weather?lat="+ lat + "&lon=" + long + "&units=metric&appid=8023c0427a071f0e4e0cf59a29b110fb", function(weather_data) {

      icon = weather_data.weather[0].icon;
      let temp = weather_data.main.temp;
=======
    $.get("https://api.openweathermap.org/data/2.5/weather?lat="+ lat + "&lon=" + long + "&units=metric&appid=[insert your API key here]", function(weather_data) {
